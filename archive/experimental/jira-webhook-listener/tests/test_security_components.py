...
from security.hmac_verifier import HMACVerifier, HMACVerificationError
from models.webhook import JiraWebhookPayload
from models.audit import AuditLogEvent, create_webhook_received_event
...
def test_webhook_validation():
    ...
    try:
        ...
        assert "path traversal" in str(e).lower() or "unsafe" in str(e).lower()
