...
from utils.channel_naming import generate_channel_name, generate_collision_suffix, ChannelNamingError
        ...
        for attempt in range(self.MAX_RETRIES):
            try:
                ...
                if error_code == 'name_taken':
                    ...
                    # Retry immediately with new name
                    response = self.slack.conversations_create(
                        name=channel_name,
                        is_private=True
                    )
                ...
                # Handle rate limiting with exponential backoff
                    ...
                    retry_after = int(e.response.headers.get('Retry-After', self.RETRY_DELAY_BASE ** attempt))
