...
cd services/slack-orchestrator
...
# Slack bot token loaded from SecretsManager (or SLACK_BOT_TOKEN env var in dev)
...
docker build -t coreline-slack-orchestrator:latest .
docker run -d \
