...
Event-driven microservice that listens for security incident notifications via Redis Pub/Sub and automatically generates compliance-ready Post-Incident Reviews (PIRs) using Claude AI.
...
```bash
cd services/coreline-brain-service
